...
function setBgImgInit() {
    ...
    switch (bg_img["type"]) {
        ...
        case "4":
            ...
            break;
        case "5":
            $('#bg').attr('src', 'https://api.vvhan.com/api/girl'); //随机COS
            break;
        case "6":
            $('#bg').attr('src', 'https://sex.nyan.xyz/api/v2/img?r18=true'); //随机涩图
            break;
    }
}
...
$(document).ready(function () {
    ...
    $("#wallpaper").on("click", ".set-wallpaper", function () {
        ...
        if (type === "4") {
            setBgImg(bg_img);
            $('#bg').attr('src', 'https://cdn.seovx.com/d/?mom=302'); //随机动漫1
            iziToast.show({
                message: '壁纸设置成功',
            });
        }
        ...
        if (type === "6") {
            setBgImg(bg_img);
            $('#bg').attr('src', 'https://sex.nyan.xyz/api/v2/img'); //随机涩图
            iziToast.show({
                message: '壁纸设置成功',
            });
        }
