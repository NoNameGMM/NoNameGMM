...
window.addEventListener('load', function () {
    ...
    setTimeout(function () {
        iziToast.show({
            timeout: 2500,
            title: hello,
            message: '欢迎来到NoNameGMM的主页'
        });
    }, 800);
}, false)

setTimeout(function () {
    $('#loading-text').html("请耐心等待喔~")
}, 3000);
...
fetch('https://v1.yiketianqi.com/api?unescape=1&version=v61&appid=41297911&appsecret=CbEVpH2D')
    .then(response => response.json())
    .then(data => {
